...
class ItemSeenInsertJob implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        $item_seen = cache()->remember('item_seen_'.\MainHelper::slug($this->model_id).\MainHelper::slug($classNameString).$this->data['ip'], 60 * 60 * 24, function () use ($classNameString, $item_seens) {
