                                        ...
                                        <div class="card-body p-6">
                                            <div class="post-header">
                                                ...
                                                <h2 class="post-title h3 mt-1 mb-3"><a class="link-dark"
                                                        href="./blog-post.html">هذا النص هو مثال لنص يمكن أن يستبدل</a>
                                                </h2>
                                            </div>
                                            <div class="post-footer">
                                                <ul class="post-meta d-flex mb-0">
                                                    <li class="post-date"> <span>14 Apr 2022</span> <i
                                                            class="fal fa-clock"></i> </li>
                                                    <li class="post-comments"><a href="#"> 4 <i
                                                                class="fal fa-comment"></i> </a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
