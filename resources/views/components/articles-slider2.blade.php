                                    ...
                                    <article>
                                        <div class="card">
                                            <figure class="card-img-top overlay overlay-1 hover-scale"><a
                                                    href="#"> <img src="/assets/img/photos/7.jpg"
                                                        alt="" /></a>
                                                <figcaption>
                                            ...
                                            <div class="card-body">
                                                <div class="post-header">
                                                    <div class="post-category text-line">
                                                        <a href="#" class="hover" rel="category">ريادة
                                                            الأعمال</a>
                                                    </div>
                                                    <!-- /.post-category -->
                                                    <h2 class="post-title h3 mt-1 mb-3"><a class="link-dark"
                                                            href="#">نص عشوائي يمكن أن يستبدل في نفس المساحة</a>
                                                    </h2>
                                                </div>
                                                <!-- /.post-header -->
                                            ...
                                            <div class="card-footer">
                                                <ul class="post-meta d-flex mb-0">
                                                    <li class="post-date"><i class="fal fa-calendar-alt"></i> <span>14
                                                            Apr 2022</span></li>
                                                    <li class="post-comments"><a href="#"><i
                                                                class="fal fa-comment"></i> 4</a></li>
                                                    <li class="post-likes ms-auto"><a href="#"><i
                                                                class="fal fa-heart"></i> 5</a></li>
                                                </ul>
                                                <!-- /.post-meta -->
                                            </div>
                                            <!-- /.card-footer -->
