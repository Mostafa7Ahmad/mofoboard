    ...
    <div style="position:relative;" class="content-block block_{{ $component->fields?->id }} px-0"
        ...
        <div class='position-relative  border-0 hoverable-elements-builder appened-element'
            ...
            <div
              ...
              filter: blur({{ $component->fields->design_background_blur }}px) grayscale({{ $component->fields->design_background_grayscale }}%);">
            </div>
            ...
            <div class='main-content-of-block py-5 py-lg-9 d-flex align-items-center justify-content-center '
                    ...
                    <div class="container px-3">
                        <div class='col-12 mx-auto {{ $component->fields->design_text_alignment }} row'>
                            @if ($component->fields->content_title != '')
                                <h2 class='font-3 font-lg-5 mb-lg-3 mb-1 content_title {{ $component->fields->design_text_alignment }}'
                                    style="color:inherit;">{{ $component->fields->content_title }}</h2>
                            @endif
                            @if ($component->fields->content_sub_title != '')
                                <p class=' mb-3 mb-lg-5  font-2 font-lg-3 content_sub_title  {{ $component->fields->design_text_alignment }} '
                            ...
                            @endif
                            <div
                                class="col-12 px-0 d-flex btns-group mt-2 {{ $component->fields->design_text_alignment }}">
                        ...
                        <div
                            ...
                            <div class="col-12 col-lg-6 d-flex align-items-center row mx-auto">
                                <div class="col-12 px-0 py-3 row ">
                                    ...
                                    @endif
                                    @if ($component->fields->content_sub_title != '')
                                        <p class=' mb-3 mb-lg-5 content_sub_title  font-2 font-lg-3 block-sub-title {{ $component->fields->design_text_alignment }} '
                                            style="opacity: 0.9;white-space:pre-line;">
                                            {{ $component->fields->content_sub_title }}</p>
                                    @endif
                                    @if ($component->fields->content_description != '')
                ...
                @if ($component->fields->block_type == 'component_features')
                    <div class="container px-3">
                        <div
                            class='{{ $component->fields->design_text_alignment }} {{ $component->fields->design_content_alignment }} row'>
                            @if ($component->fields->content_title != '')
                                <h2 class='font-3 font-lg-5 content_title mb-lg-3 mb-1 block-head {{ $component->fields->design_text_alignment }}'
                                    style="color:inherit;">{{ $component->fields->content_title }}</h2>
                            @endif
                            @if ($component->fields->content_description != '')
                                <p class=' mb-3 mb-lg-5 content_description font-1 font-lg-2 block-sub-title {{ $component->fields->design_text_alignment }}'
                            ...
                            @endif
                            <div
                                class="col-12 px-0 d-flex features-group row {{ $component->fields->design_text_alignment }} {{ $component->fields->design_content_alignment }}">
                                @foreach ($component->fields->features as $feature)
                                    <div
                                        class="p-1 p-lg-3 mx-auto col-{{ 12 / $component->fields->design_columns_mobile }} col-lg-{{ 12 / $component->fields->design_columns }} my-3">
                                        ...
                                        <div class="col-12 mb-1 px-lg-2 px-1 text-center">
                                            <img src="{{ $feature->fields->image_url }}"
                                                style="width:100px;max-width:90%">
                                        </div>
                                        <div class="col-12 font-2 font-lg-3 mb-1 px-2 text-center">
                                            {{ $feature->fields->title }}
                                        </div>
                                        <div class="col-12 px-1 px-lg-2 text-center font-1 font-lg-2"
                ...
                @if ($component->fields->block_type == 'component_faqs')
                    <div class="container px-3">
                        <div class='{{ $component->fields->design_text_alignment }} row'>
                            ...
                            @endif
                            <div
                                class="col-12 px-0 d-flex faqs-group row {{ $component->fields->design_text_alignment }}">
                                        ...
                                        <div class="col-12 px-0 py-1">
                                            <div class="accordion-item mb-1"
                                                ...
                                                <h2 class="accordion-header">
                                                    <button class="accordion-button font-1 font-lg-2" type="button"
                                        ...
                                        <div class="swiper-wrapper">
                                            @foreach ($component->fields->features as $feature)
                                                <div class="swiper-slide text-center d-flex align-items-center justify-content-center  "
                                                    style="background-image: url('{{ $feature->fields->image_url }}');background-repeat: no-repeat;background-position: center;background-size: cover;border-radius: 8px;position: relative;overflow: hidden;">
                                                        ...
                                                        <div style="position: absolute;top: 0px;bottom: 0px;width: 100%;right: 0px;left: 0px;background: rgb(0 0 0 / 10%);"
                                                            ...
                                                            <div class="col-12 p-3">
                                                                <div class="font-3 font-lg-5 col-12 p-1 text-center"
                                                                    style="color:#fff">{{ $feature->fields->title }}
                                                                </div>
