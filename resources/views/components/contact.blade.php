...
<div class="col-lg-12">
    <form id="contact-form-{{ $ulid }}" method="POST" action="{{ route('contact-post') }}">
        ...
        <div class="row gx-4">
            ...
            <div class="col-md-12">
                <div class="form-floating mb-4">
                    <input id="form_email" type="email" name="email" class="form-control" placeholder="ahmed@gmail.com"
                        required>
            ...
            <div class="col-12">
                <div class="form-floating mb-4">
                    <textarea id="form_message" name="message" class="form-control" placeholder="محتوى رسالتك"
