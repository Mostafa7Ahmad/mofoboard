                                ...
                                <div class="col-12 p-0 row">
                                    ...
                                    <div class="col-8 d-flex justify-content-end align-items-center">
                                        ...
                                        <span style="font-weight: bold;"><a
                                                href="{{ route('admin.traffics.logs') }}">{{ count($data['current_visitors']) }}</a></span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-12 p-3">
                        @foreach ($data['top_pages'] as $page)
                            <div class="col-12 px-2 py-1 row">
                                <div class="col-4 p-0">
                                    <span
                                        style="width: 30px;height: 17px;font-weight: bold;background: #7b60fb;color: #fff;"
                                ...
                                <div class="col-8 text-truncate p-0" style="direction:ltr;font-size: 12px;">
                                    <a href="{{ $page->url }}" target="_blank"
                                        style="color:inherit">{{ urldecode(str_replace(env('APP_URL'), '', $page->url)) }}</a>
                                </div>
                            </div>
                        @endforeach
                    </div>
