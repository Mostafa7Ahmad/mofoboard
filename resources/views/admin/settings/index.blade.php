				...
				<div class="col-12 col-lg-8 px-3 py-5">
					...
					<div class="col-12 row p-0 taber active" id="general-tab">
						<div class="col-12 px-0 d-flex mb-3 row pb-3">
							...
							<div class="col-12 col-lg-9 px-2">
								<input type="" name="settings[website_name]" class="form-control"
						...
						<div class="col-12 px-0 d-flex mb-3 row pb-3">
							...
							<div class="col-12 col-lg-9 px-2">
								<textarea name="settings[website_bio]"
									class="form-control">{{$settings['website_bio']}}</textarea>
							</div>
						</div>
						<div class="col-12 px-0 d-flex mb-3 row pb-3">
							<div class="col-12 col-lg-3 px-2 text-lg-end pt-1 pb-3 pb-lg-0">
						...
						<div class="col-12 px-0 d-flex mb-3 row pb-3">
							...
							<div class="col-12 col-lg-9 px-2">
								...
								<div class="col-12 p-2">
									<img src="{{$settings['get_website_wide_logo']}}"
					...
					<div class="col-12 row p-0 taber" id="appearance-tab">
						...
						<div class="col-12 px-0 d-flex mb-3 row pb-3">
							...
							<div class="col-12 col-lg-9 px-2">
								<input type="color" name="settings[main_color]" value="{{$settings['main_color']}}"
									maxlength="190">
							</div>
						</div>
						<div class="col-12 px-0 d-flex mb-3 row pb-3">
							...
							<div class="col-12 col-lg-9 px-2">
								<input type="color" name="settings[hover_color]" value="{{$settings['hover_color']}}"
									maxlength="190">
							</div>
						</div>
						<div class="col-12 px-0 d-flex mb-3 row pb-3">
					...
					<div class="col-12 row p-0 taber" id="links-tab">
						<div class="col-12 px-0 d-flex mb-3 row pb-3">
							...
							<div class="col-12 col-lg-9 px-2">
								<input type="" name="settings[phone]" class="form-control" value="{{$settings['phone']}}"
									maxlength="190">
							</div>
						</div>
						<div class="col-12 px-0 d-flex mb-3 row pb-3">
							...
							<div class="col-12 col-lg-9 px-2">
								<input type="" name="settings[phone2]" class="form-control" value="{{$settings['phone2']}}"
									maxlength="190">
							</div>
						</div>
						<div class="col-12 px-0 d-flex mb-3 row pb-3">
						...
						<div class="col-12 px-0 d-flex mb-3 row pb-3">
							...
							<div class="col-12 col-lg-9 px-2">
								<input type="url" name="settings[tiktok_link]" class="form-control"
						...
						<div class="col-12 px-0 d-flex mb-3 row pb-3">
							...
							<div class="col-12 col-lg-9 px-2">
								<input type="url" name="settings[nafezly_link]" class="form-control"
						...
						<div class="col-12 px-0 d-flex mb-3 row pb-3">
							...
							<div class="col-12 col-lg-9 px-2">
								<input type="url" name="settings[another_link3]" class="form-control"
					...
					{{-- <div class="col-12 row p-0 taber" id="pages-tab">
						...
						<div class="col-12 px-0 d-flex mb-3 row pb-3">
							...
							<div class="col-12 col-lg-9 px-2">
								<textarea name="settings[contact_page]" class="form-control"
									style="min-height: 300px">{{$settings['contact_page']}}</textarea>
							</div>
						</div>
					...
					<div class="col-12 row p-0 taber" id="codes-tab">
						<div class="col-12 px-0 d-flex mb-3 row pb-3">
							...
							<div class="col-12 col-lg-9 px-2">
								<textarea name="settings[header_code]" class="form-control"
									style="min-height: 200px;text-align: left;direction: ltr;">{{$settings['header_code']}}</textarea>
							</div>
						</div>
						<div class="col-12 px-0 d-flex mb-3 row pb-3">
							<div class="col-12 col-lg-3 px-2 text-lg-end pt-1 pb-3 pb-lg-0">
							...
							<div class="col-12 col-lg-9 px-2">
								<textarea name="settings[footer_code]" class="form-control"
									style="min-height: 200px;text-align: left;direction: ltr;">{{$settings['footer_code']}}</textarea>
							</div>
						</div>
						<div class="col-12 px-0 d-flex mb-3 row pb-3">
							<div class="col-12 col-lg-3 px-2 text-lg-end pt-1 pb-3 pb-lg-0">
							...
							<div class="col-12 col-lg-9 px-2">
								<textarea name="settings[robots_txt]" class="form-control"
									style="min-height: 200px;text-align: left;direction: ltr;">{{$settings['robots_txt']}}</textarea>
							</div>
						</div>
					</div>
