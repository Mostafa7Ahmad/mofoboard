                        ...
                        <div class="col-12 item-container px-0 d-flex">
                            ...
                            <div style="width: calc(100% - 50px)" class="px-2 item-container-title">
                                ...
                                @if ($link['notification'])
                                    <span
                                        style="background: #d34339;border-radius: 2px;color:var(--background-1)!important;display: inline-block;font-size: 11px;text-align: center;padding: 1px 5px;margin: 0px 8px">{{ $link['notification'] }}</span>
                                @endif
                            </div>
                        </div>
                    </a>
                    ...
                    <div class="col-12 px-0 aside-conente-container" style="cursor: pointer;">
                        <div class="col-12 item px-0 d-flex row ">
                            ...
                            <div class="col-12 px-0">
                                <ul class="sub-item font-1 p-0" style="list-style:none;">
