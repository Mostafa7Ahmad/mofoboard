                ...
                <div class="col-12 col-lg-12 p-0 main-box">
                    ...
                    <div class="col-12 px-0">
                        <div class="col-12 px-3 py-3">
                            <span class="fas mx-1fa-info mx-2"></span> صلاحيات المستخدم
                        </div>
                                            ...
                                            <td style="width: 56px;">
                                                ...
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input" type="checkbox"
                                                        ...
                                                        @if ($user->hasPermission($permission->table . '-create')) checked @endif
                                                        name="permissions[]">
                                                </div>
                                            </td>
                                        @else
                                            ...
                                            <td style="width: 56px;">
                                                ...
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input" type="checkbox"
                                                        ...
                                                        @if ($user->hasPermission($permission->table . '-read')) checked @endif
                                                        name="permissions[]">
                                                </div>
                                            </td>
                                        @else
                                            ...
                                            <td style="width: 56px;">
                                                ...
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input" type="checkbox"
                                                        ...
                                                        @if ($user->hasPermission($permission->table . '-update')) checked @endif
                                                        name="permissions[]">
                                                </div>
                                            </td>
                                        @else
                                            ...
                                            <td style="width: 56px;">
                                                ...
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input" type="checkbox"
                                                        ...
                                                        @if ($user->hasPermission($permission->table . '-delete')) checked @endif
                                                        name="permissions[]">
                                                </div>
                                            </td>
                                        @else
