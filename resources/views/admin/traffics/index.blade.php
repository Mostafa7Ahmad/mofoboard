...
@section('content')
    ...
    <div class="col-12 px-0 row d-flex pb-2">
        <form method="GET" action="{{ route('admin.traffics.index') }}" class="row col-12 px-0">
            ...
            <div class="col-6 col-lg-2 pb-1">
                <input type="" name="user_id" placeholder="user_id" value="{{ \Request::get('user_id') }}"
                    class="form-control">
            </div>
            <div class="col-6 col-lg-2 pb-1">
                <input type="" name="domain" placeholder="domain" value="{{ \Request::get('domain') }}"
                    class="form-control">
            </div>
            <div class="col-6 col-lg-2 pb-1">
                <input type="" name="country_code" placeholder="country_code"
                    value="{{ \Request::get('country_code') }}" class="form-control">
            </div>
            <div class="col-6 col-lg-2 pb-1">
                    ...
                    <tr>
                        <td
                            style="font-size: 12px;
                              @if ($traffic->user_id != null) background: green; @endif
                              ">
                        ...
                        <td style="font-size: 12px">
                            <a href="{{ $traffic->traffic_landing }}" target="_blank" data-container="body"
                                data-toggle="popover" data-placement="top" data-content="{{ $traffic->user_agent }}">
                        ...
                        <td style="font-size: 12px">
                            <a href="{{ route('admin.traffics.logs', ['rate_limit_id' => $traffic->id]) }}">
                                <span style="width: 30px;height: 30px;background: #2381c6;color:#fff;border-radius: 50%"
                                    class="text-center d-inline-block font-3">
                        ...
                        <td style="font-size: 12px">
                            <span data-container="body" data-toggle="popover" data-placement="top"
                                data-content="{{ $traffic->device }}">{{ \Carbon::parse($traffic->created_at)->diffForHumans() }}</span>
                        </td>
                    </tr>
                @endforeach
            </tbody>
