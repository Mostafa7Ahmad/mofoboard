                    ...
                    <div class="col-12 col-md-6 px-0 d-flex mb-3">
                        ...
                        <div class="col-9 px-2">
                            <input type="" name="title" class="form-control"
                                value="{{ old('title', $announcement) }}" required="" min="3" max="255">
                        </div>
                    </div>
                    <div class="col-12 col-md-6 px-0 d-flex mb-3">
                        <div class="col-3 px-2 text-start pt-1">
                        ...
                        <div class="col-9 px-2">
                            <textarea class="form-control" name="description" min="3" max="1000" style="min-height: 200px"
                                required="">{{ old('description', $announcement) }}</textarea>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 px-0 d-flex mb-3">
                        <div class="col-3 px-2 text-start pt-1">
                        ...
                        <div class="col-9 px-2">
                            <input type="datetime-local" name="start_date" value="{{ old('start_date', $announcement) }}"
                                class="form-control">
                        </div>
                    </div>
                    <div class="col-12 col-md-6 px-0 d-flex mb-3">
                        ...
                        <div class="col-9 px-2">
                            <input type="datetime-local" name="end_date" value="{{ old('end_date', $announcement) }}"
                                class="form-control">
                        </div>
                    </div>
                    <div class="col-12 col-md-6 px-0 d-flex mb-3">
                        ...
                        <div class="col-9 px-2">
                            <input type="url" name="url" value="{{ old('url', $announcement) }}"
                                class="form-control">
                        </div>
                    </div>
                    <div class="col-12 col-md-6 px-0 d-flex mb-3">
                        ...
                        <div class="col-9 px-2">
                            <div class="form-switch">
                                <input name="open_url_in" class="form-check-input" type="checkbox"
                                    ...
                                    {{ old('open_url_in', $announcement) == 'NEW_WINDOW' ? 'checked' : '' }}
                                    style="width: 50px;height:25px" value="NEW_WINDOW">
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 px-0 d-flex mb-3">
                    ...
                    <div class="col-12 col-md-6 px-0 d-flex mb-3">
                        ...
                        <div class="col-9 px-2">
                            <button class="btn pb-2 px-4"
                                style="background: #ffa725;border-radius: 0px;color: #fff ">إعتماد</button>
                        </div>
