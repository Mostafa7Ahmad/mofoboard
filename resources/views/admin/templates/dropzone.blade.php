<script>
    $('{{ isset($selector) && !is_null($selector) ? $selector : '#file-uploader-nafezly' }} .file-uploader-files')
        .fileuploader({
            addMore: true,
            ...
            enableApi: true,
            extensions: @if (isset($accepted_files) && !is_null($accepted_files))
                {!! $accepted_files !!}
            @else
                @php
            ...
            upload: {
                ...
                onSuccess: function(result, item) {
                    ...
                    $("{{ isset($enable_selector_after_upload) && !is_null($enable_selector_after_upload) ? $enable_selector_after_upload : '#upload-button' }}")
                        .attr("disabled", false);
