    ...
    */
    ...
    <div class="p-0 builder-main-container"
        ...
        <div id="import-template"
            style="display:none;max-width:100%;width: 95%;height: 95dvh;overflow: auto;background: rgb(238, 244, 245);">
            <div class="col-12 p-0">
                            ...
                            <div class="col-12 p-3" style="background: var(--bg-main);">
                                <div class="col p-0 row d-flex align-items-center">
                                    <div class="col-12 p-0" style="height:250px;overflow:auto;">
                                        <img :src="internal_item.image" style="max-width: 100%;" class="rounded"
                                            data-fancybox />
                                    </div>
                                    <div class="col-12 p-0">
                                ...
                                <div class="col-auto p-0 py-2">
                                    <a class="rounded font-1 btn btn-outline-success" href="#"
                                        v-on:click="import_content_now(internal_item.slug)" data-width="400">استيراد</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-12 p-0 row">
            <div class="col-12 p-0" style="overflow:hidden">
                <div class="col-12 row py-1 px-3 d-flex align-items-center"
                    style="background:#fff;border-block: 1px solid #f1f1f1;height: 65px;">
                    <div class="col px-1 row d-flex align-items-center" style="height: 100%;width: calc(100% - 320px);">
                        <div class="col-auto px-0 d-flex justify-content-center align-items-center "
                            style="width: 55px;cursor: pointer;height: 100%;" @click="aside_toggle()">
                    ...
                    <div class="col-auto px-1 d-flex justify-content-end" style="width:320px">
                        <button class="btn btn-primary py-1 px-3 mx-1 font-1" v-on:click="submit_page_updates()">حفظ
                            التعديلات</button>
                        <div class="dropdown d-flex align-items-center">
                            <a class=" border-0 py-0 px-2" type="button" data-bs-toggle="dropdown" aria-expanded="false"
                            ...
                            <ul class="dropdown-menu py-2" style="z-index: 100000;">
                                {{-- <li class="dropdown-item p-0 font-1">
                                    <a class=" border-0 px-3 py-2 col-12 btn-sm font-1  d-flex justify-content-between align-items-center"
                                        data-fancybox data-src="#import-template" href="#" style="color: inherit;"
                                        v-on:click="load_templates()">
                                        <span class="font-1" style="color:inherit!important">استيراد نموذج جاهز</span>
                                        <span class="fal fa-file font-1"
                                            style="width: 20px;text-align:center;color:inherit!important"></span>
                                    </a>
                                </li> --}}
                                <li class="dropdown-item p-0 font-1">
                                    <a class=" border-0 px-3 py-2 col-12 btn-sm font-1  d-flex justify-content-between align-items-center"
                                        data-fancybox data-src="#import-page" href="#" style="color: inherit;">
                                        <span class="font-1" style="color:inherit!important">استيراد مخصص</span>
                                        <span class="fal fa-download font-1"
                                            style="width: 20px;text-align:center;color:inherit!important"></span>
                                    </a>
                                </li>
                                <li class="dropdown-item p-0 font-1">
                                    <a class=" border-0 px-3 py-2 col-12 btn-sm font-1  d-flex justify-content-between align-items-center"
                                        v-on:click="copy_page_content()" href="#" style="color: inherit;">
                                        <span class="font-1" style="color:inherit!important">نسخ المحتوى</span>
                                        <span class="fal fa-copy font-1"
                                            style="width: 20px;text-align:center;color:inherit!important"></span>
                                    </a>
                                </li>
                                <li class="dropdown-item p-0 font-1">
                ...
                <div class="col-12 p-0" style="min-height: 80dvh;">
                    <div class="col-12 p-0 row">
                        <div class="col-auto p-0 "
                            style="top: 0;width: 360px;margin-right: 0px;z-index: 10000;position: relative;background: #fff;"
                            id="builder-aside">
                            <div style="height:calc( 100dvh - 65px );overflow: hidden;"
                                class="p-0 col-12 add-component aside-wedgit">
                                <div class="col-12 px-3 mb-2 row">
                                    <div class="col-auto p-0 d-flex align-items-center justify-content-center"
                                        v-on:click="aside_toggle()">
                                        <span class="btn btn-light"
                                            style="width: 40px;height: 40px;display: inline-block;padding: 0px;display: flex;align-items: center;justify-content: center;border:1px solid #eeeeee;border-radius:50%;color:inherit;"><span
                                                class="fas mx-1fa-chevron-right" style="font-size:18px;"></span></span>
                                    </div>
                                ...
                                <div class="col-12 p-3 row " id="items" style="height:calc(100dvh - 150px);overflow: auto;">
                                    <div class="col-12 p-0 component mb-2"
                                        ...
                                        <div class="p-1" style="background:#f1f1f1;border-radius:10px">
                                            <img src="/images/components/component_banner.png"
                                    ...
                                    <div class="col-12 p-0 component mb-2"
                                        v-on:click="template_generator('component_text_with_image')"
                                        data-id="component_text_with_image" style="cursor: pointer;">
                                        <div class="p-1" style="background:#f1f1f1;border-radius:10px">
                                            <img src="/images/components/component_text_with_image.png"
                                                style="width:100%;border-radius: 10px;" class="p-1">
                                            <div class="col-12 font-2 px-2 d-flex">
                                                <div class="col px-0">
                                                    نص مع صورة
                                    ...
                                    <div class="col-12 p-0 component mb-2"
                                        v-on:click="template_generator('component_text_with_video')"
                                        data-id="component_text_with_video" style="cursor: pointer;">
                                        <div class="p-1" style="background:#f1f1f1;border-radius:10px">
                                            <img src="/images/components/component_text_with_video.png"
                                                style="width:100%;border-radius: 10px;" class="p-1">
                                            <div class="col-12 font-2 px-2 d-flex">
                                                <div class="col px-0">
                                                    نص مع فيديو
                                    ...
                                    <div class="col-12 p-0 component mb-2"
                                        v-on:click="template_generator('component_features')" data-id="component_features"
                                        style="cursor: pointer;">
                                        <div class="p-1" style="background:#f1f1f1;border-radius:10px">
                                            <img src="/images/components/component_features.png"
                                                style="width:100%;border-radius: 10px;" class="p-1">
                                            <div class="col-12 font-2 px-2 d-flex">
                                                <div class="col px-0">
                                                    المميزات
                                    ...
                                    <div class="col-12 p-0 component mb-2"
                                        v-on:click="template_generator('component_contact')" data-id="contact_form"
                                        style="cursor: pointer;">
                                        <div class="p-1" style="background:#f1f1f1;border-radius:10px">
                                            <img src="/images/components/component_contact.png"
                                                style="width:100%;border-radius: 10px;" class="p-1">
                                            <div class="col-12 font-2 px-2 d-flex">
                                                <div class="col px-0">
                                                    نموذج تواصل معنا
                                    ...
                                    <div class="col-12 p-0 component mb-2"
                                        v-on:click="template_generator('component_slider')" data-id="component_slider"
                                        style="cursor: pointer;">
                                        <div class="p-1" style="background:#f1f1f1;border-radius:10px">
                                            <img src="/images/components/component_slider.png"
                                                style="width:100%;border-radius: 10px;" class="p-1">
                                            <div class="col-12 font-2 px-2 d-flex">
                                                <div class="col px-0">
                                                    صور متعددة
                                    ...
                                    <div class="col-12 p-0 component mb-2"
                                        v-on:click="template_generator('component_content')" data-id="contact_form"
                                        style="cursor: pointer;">
                                        <div class="p-1" style="background:#f1f1f1;border-radius:10px">
                                            <img src="/images/components/component_content.png"
                                                style="width:100%;border-radius: 10px;" class="p-1">
                                            <div class="col-12 font-2 px-2 d-flex">
                                                <div class="col px-0">
                                                    محتويات الموقع
                            ...
                            <div style="display: none;height: calc( 100dvh - 65px );overflow: hidden;"
                                class="p-0 col-12 edit-component aside-wedgit">
                                <div class="col-12 px-3 mb-2 row">
                                    <div class="col-auto p-0 d-flex align-items-center justify-content-center"
                                        v-on:click="change_aside_view('add_component')">
                                        <span class="btn btn-light"
                                            style="width: 40px;height: 40px;display: inline-block;padding: 0px;display: flex;align-items: center;justify-content: center;border:1px solid #eeeeee;border-radius:50%;color:inherit;"><span
                                                class="fas mx-1fa-chevron-right" style="font-size:18px;"></span></span>
                                    </div>
                                    <div class="col p-0 font-3">
                                            ...
                                            <div class="col-auto p-0">
                                                <div class="dropdown d-flex align-items-center">
                                                    ...
                                                    <ul class="dropdown-menu py-2" style="z-index: 100000;">
                                                        <li class="dropdown-item p-0 font-1">
                                                            <a class=" border-0 px-3 py-2 col-12 btn-sm font-1  d-flex justify-content-between align-items-center"
                                                                v-on:click="copy_block_content()" href="#"
                                                                style="color: inherit;">
                                                                <span class="font-1" style="color:inherit!important">نسخ
                                                                    المحتوى</span>
                                                                <span class="fal fa-copy font-1"
                                                                    style="width: 20px;text-align:center;color:inherit!important"></span>
                                                            </a>
                                                        ...
                                                        <li class="dropdown-item p-0 font-1">
                                                            <a class=" border-0 px-3 py-2 col-12 btn-sm font-1  d-flex justify-content-between align-items-center"
                                                                v-on:click="change_aside_view('add_component');contents[selected_page]?.splice(contents[selected_page]?.findIndex(block => block.id === selected_unique_id), 1);"
                                                                href="#" style="color: #ff5454;">
                                                                <span class="font-1" style="color:#ff5454!important">حذف
                                                                    القسم</span>
                                                                <span class="fal fa-trash font-1"
                                                                    style="width: 20px;text-align:center;color:#ff5454!important"></span>
                                                            </a>
                                                        </li>
                                                    </ul>
                                        ...
                                        {{-- <h3 class="p-3 m-0 d-flex justify-content-between align-items-center">
                                            <span>تعديل القسم</span>
                                            <span class="far fa-trash ms-2" v-on:click=""
                                                style="color:#f44336;font-size: 18px;cursor: pointer;"></span>
                                        </h3> --}}
                                    </div>
                                </div>
                                <div class="col-12 p-3 " id="builder-editor"
                                            ...
                                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                                <div class="col p-1">
                                                    <button style="padding: 5px;border-radius: 5px;"
                                                        ...
                                                        v-on:click="change_edit_tab('content')">المحتوى</button>
                                                </div>
                                                <div class="col p-1">
                                                    <button style="padding: 5px;border-radius: 5px;"
                                                        ...
                                                        v-on:click="change_edit_tab('design')">التصميم</button>
                                                </div>
                                            </div>
                                        </nav>
                                    </div>
                                    <div class="tab-content" id="nav-tabContent">
                                        <div v-if="selected_unique_id">
                                            {{-- <draggable v-model="dums" handle=".handle"
                                                :group="{ name: 'people', pull: 'clone', put: false }" ghost-class="ghost"
                                                :sort="false" @change="log">
                                            </draggable> --}}
                                        ...
                                        <div :class="{'show active': current_edit_tab === 'content'}" class="tab-pane fade"
                                            ...
                                            <div v-if="('content_title' in (contents[selected_page]?.find(block => block.id === selected_unique_id)?.fields || {}) )"
                                                ...
                                                <div class="col-12 px-2 mb-3">
                                                    <input class="form-control" type="" name=""
                                                        v-model="(contents[selected_page]?.find(block => block.id === selected_unique_id)?.fields || {}).content_title"
                                                        style="font-size:14px;border-radius: 2px;">
                                                </div>
                                            </div>
                                            <div v-if="('content_sub_title' in (contents[selected_page]?.find(block => block.id === selected_unique_id)?.fields || {}) )"
                                                class="col-12 px-0 my-2 py-2">
                                                <div class="col-12 px-3 mb-2 font-1">
                                                    العنوان الفرعي
                                                </div>
                                                <div class="col-12 px-2 mb-3">
                                                    <input class="form-control" type="" name=""
                                                        v-model="(contents[selected_page]?.find(block => block.id === selected_unique_id)?.fields || {}).content_sub_title"
                                                        style="font-size:14px;border-radius: 2px;">
                                                </div>
                                            </div>
                                            <div v-if="('content_video_url' in (contents[selected_page]?.find(block => block.id === selected_unique_id)?.fields || {}) )"
                                                class="col-12 px-0 my-2 py-2">
                                                <div class="col-12 px-3 mb-2 font-1">
                                                    العنوان الفيديو
                                                </div>
                                                <div class="col-12 px-2 mb-3">
                                                    <input class="form-control" type="" name=""
                                                        v-model="(contents[selected_page]?.find(block => block.id === selected_unique_id)?.fields || {}).content_video_url"
                                                        style="font-size:14px;border-radius: 2px;">
                                                </div>
                                            </div>
                                            <div v-if="('content_image_url' in (contents[selected_page]?.find(block => block.id === selected_unique_id)?.fields || {}) )"
                                                class="col-12 p-0">
                                                <div class="col-12 px-3 mb-2 font-1">
                                                    الصورة
                                                </div>
                                                <div class="col-12 px-2 mb-3">
                                                    <div v-if="(contents[selected_page]?.find(block => block.id === selected_unique_id)?.fields || {}).content_image_url == null"
                                                        class="col-12 p-0 row d-flex align-items-center">
                                                        <div style="width: 100px;padding: 0px;position: relative;height: 50px;overflow: hidden;background: #f1f1f1;cursor: pointer;"
                                                            class="d-flex align-items-center justify-content-center">
                                                            <span style="font-size:13px"> <span
                                                                    class="fal fa-upload"></span> ارفع أو</span>
                                                            <input type="file"
                                                    ...
                                                    <div v-if="(contents[selected_page]?.find(block => block.id === selected_unique_id)?.fields || {}).content_image_url != null"
                                                        class="col-12 p-2" style="border:1px solid #f1f1f1">
                                            ...
                                            <div v-if="('content_description' in (contents[selected_page]?.find(block => block.id === selected_unique_id)?.fields || {}) )"
                                                class="col-12 px-0 my-2 py-2">
                                                <div class="col-12 px-3 mb-2 font-1">
                                                    الوصف
                                                </div>
                                                <div class="col-12 px-2 mb-3">
                                                    <textarea class="form-control"
                                                        v-model="(contents[selected_page]?.find(block => block.id === selected_unique_id)?.fields || {}).content_description"
                                                        style="border-radius: 2px;min-height: 150px;"></textarea>
                                                </div>
                                            </div>
                                            <div v-if="('content' in (contents[selected_page]?.find(block => block.id === selected_unique_id)?.fields || {}) )"
                                                ...
                                                <div class="col-6 px-0 my-1">
                                                    ...
                                                    <div class="col-12 px-2 mb-3">
                                                        <select
                                                            v-model="(contents[selected_page]?.find(block => block.id === selected_unique_id)?.fields || {}).content.type"
                                                            class="form-control">
                                                ...
                                                <div v-if="loaded_content_type" class="col-6 px-0 my-1">
                                                    ...
                                                    <div class="col-12 px-2 mb-3">
                                                        <div class="dropdown col-12 p-0">
                                                            <a class="  col-12 form-control" type="button"
                                                                data-bs-toggle="dropdown" aria-expanded="false"
                                                                data-bs-auto-close="outside">
                                                                <span
                                                                    v-if="(contents[selected_page]?.find(block => block.id === selected_unique_id)?.fields || {}).content.selected_slugs.length == 0 ">الكل</span>
                                                                <span
                                                            ...
                                                            <ul v-if="loaded_content_type" class="dropdown-menu px-3"
                                                                style="max-width:130px;max-height: 200px;overflow: auto;">
                                                                <li v-for="loaded_item in loaded_content_type"
                                                                    :key="loaded_item.slug">
                                                                    <div class="col-12 p-0 row d-flex font-1 py-1"
                                                                        style="color:#000">
                                                ...
                                                <div class="col-6 px-0 my-1">
                                                    ...
                                                    <div class="col-12 px-2 mb-3">
                                                        <select
                                                            v-model="(contents[selected_page]?.find(block => block.id === selected_unique_id)?.fields || {}).content.view_type"
                                                            class="form-control" @change="refresh_loaded_content()">
                                                ...
                                                <div class="col-6 px-0 my-1">
                                                    ...
                                                    <div class="col-12 px-2 mb-3">
                                                        <input type="" name=""
                                                            v-model="(contents[selected_page]?.find(block => block.id === selected_unique_id)?.fields || {}).content.items_count"
                                                            class="form-control" @change="refresh_loaded_content()">
                                                    </div>
                                                </div>
                                                <div class="col px-0 my-1">
                                                    ...
                                                    <div class="col-12 px-2 mb-3">
                                                        <select
                                                            v-model="(contents[selected_page]?.find(block => block.id === selected_unique_id)?.fields || {}).content.paginate"
                                                            @change="refresh_loaded_content()" class="form-control">
                                            ...
                                            <div v-if="('buttons' in (contents[selected_page]?.find(block => block.id === selected_unique_id)?.fields || {}) )"
                                                class="col-12 px-0 my-2 py-2">
                                                <div class="col-12 px-3 mb-2 font-1">
                                                    الأزرار
                                                </div>
                                                <div class="col-12 px-0 mb-3 accordion">
                                                                        ...
                                                                        <div class="col-6 px-0 my-1">
                                                                            ...
                                                                            <div class="col-12 px-2 mb-3">
                                                                                <select class="form-control"
                                                                                    ...
                                                                                    <option value="btn-outline-success">
                                                                                        رئيسي ناجح خارجي</option>
                                                                                    <option value="btn-outline-primary">
                                                                                        رئيسي معلومة خارجي</option>
                                                                                    <option value="btn-outline-secondary">
                                                                                        ثانوي خارجي</option>
                                                                                    <option value="btn-outline-light">خفيف
                                                                                        خارجي</option>
                                                                                </select>
                                                                            </div>
                                                                        </div>
                                                    ...
                                                    <div class="col-12 p-0">
                                                        <span v-on:click="add_new_button(selected_unique_id,selected_type)"
                                                            class="col-12 btn btn-outline-primary py-1 px-5"><span
                                                                class="fas mx-1fa-plus ms-2"></span> أضف زر جديد</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div v-if="('features' in (contents[selected_page]?.find(block => block.id === selected_unique_id)?.fields || {}) )"
                                                class="col-12 px-0 my-2 py-2">
                                                <div class="col-12 px-3 mb-2 font-1">
                                                    الميزات
                                                </div>
                                                                    ...
                                                                    <div :id="'collapse_'+ element.id"
                                                                        ...
                                                                        <div class="accordion-body px-2 py-3 row">
                                                                            ...
                                                                            <div class="col-12 px-0 my-1">
                                                                                ...
                                                                                <div class="col-12 px-2 mb-3">
                                                                                    <div v-if="element.fields?.image_url == null"
                                                                                        class="col-12 p-0 row d-flex align-items-center">
                                                                                        <div style="width: 100px;padding: 0px;position: relative;height: 50px;overflow: hidden;background: #f1f1f1;cursor: pointer;"
                                                                                            class="d-flex align-items-center justify-content-center">
                                                                                            <span style="font-size:13px">
                                                                                                <span
                                                                                                    class="fal fa-upload"></span>
                                                                                                ارفع أو</span>
                                                                                            <input type="file"
                                                                                                style="width:100%;opacity: 0;height: 100%;position: absolute;right: 0px;top: 0px;"
                                                                                                @change="upload_image"
                                                                                    ...
                                                                                    <div v-if="element.fields.image_url != null"
                                                                                        ...
                                                                                        <div class="col-12 p-0 mb-3">
                                                                                            <div
                                                                                                ...
                                                                                                <span class="fal fa-times"
                                                                                                    style="width: 25px;height: 25px;display: flex;align-items: center;justify-content: center;position: absolute;left: 10px;color: white;top: 10px;border-radius: 50%;background: rgb(255 0 0 / 55%);cursor: pointer;font-size: 12px;"
                                                                                                    v-on:click="element.fields.image_url = null;"></span>
                                            ...
                                            <div v-if="('faqs' in (contents[selected_page]?.find(block => block.id === selected_unique_id)?.fields || {}) )"
                                                class="col-12 px-0 my-2 py-2">
                                                <div class="col-12 px-3 mb-2 font-1">
                                                    الأسئلة
                                                </div>
                                                <div class="col-12 px-0 mb-3 accordion">
                                                    ...
                                                    <div class="col-12 p-0">
                                                        <span v-on:click="add_new_faq(selected_unique_id,selected_type)"
                                                            class="col-12 btn btn-outline-primary py-1 px-5"><span
                                                                class="fas mx-1fa-plus ms-2"></span> أضف جديد</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div v-if="('content_html' in (contents[selected_page]?.find(block => block.id === selected_unique_id)?.fields || {}) )"
                                                class="col-12 px-0 my-2 py-2">
                                                <div class="col-12 px-3 mb-2 font-1">
                                                    كود html,css,js مخصص
                                                </div>
                                                <div class="col-12 px-2 mb-3">
                                                    <textarea class="form-control code-highlight"
                                                        style="min-height: 200px;direction: ltr;background: #002b36!important;color:#fff!important"
                                                        v-model="(contents[selected_page]?.find(block => block.id === selected_unique_id)?.fields || {}).content_html"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div :class="{'show active': current_edit_tab === 'design'}" class="tab-pane fade"
                                            ...
                                            <div v-if="('design_columns' in (contents[selected_page]?.find(block => block.id === selected_unique_id)?.fields || {}) )"
                                                ...
                                                <div class="col-12 px-2 mb-3 row d-flex justify-content-between ">
                                                    <span v-for="(column,column_index) in design_columns"
                                                        :key="column_index"
                                            ...
                                            <div v-if="('design_background_url' in (contents[selected_page]?.find(block => block.id === selected_unique_id)?.fields || {}) )"
                                                class="col-12 px-0 my-2 py-2">
                                                <div class="col-12 px-3 mb-2 font-1">
                                                    صورة الخلفية
                                                </div>
                                                <div class="col-12 px-2 mb-3 row d-flex align-items-center ">
                                                    <div class="col-12 p-0">
                                                        <div v-if="(contents[selected_page]?.find(block => block.id === selected_unique_id)?.fields || {}).design_background_url == null"
                                                            class="col-12 p-0 row d-flex align-items-center">
                                                            <div style="width: 100px;padding: 0px;position: relative;height: 50px;overflow: hidden;background: #f1f1f1;cursor: pointer;"
                                                                class="d-flex align-items-center justify-content-center">
                                                                <span style="font-size:13px"> <span
                                                        ...
                                                        <div v-if="(contents[selected_page]?.find(block => block.id === selected_unique_id)?.fields || {}).design_background_url != null"
                                                            ...
                                                            <div class="col-12 px-0 py-1">
                                                                <div class="col-12 py-0 px-0" style="font-size:13px">تدرج
                                                                    اللون الرمادي</div>
                                                                <input type="range"
                                                            ...
                                                            <div class="col-12 px-0 py-1">
                                                                <div class="col-12 py-0 px-0" style="font-size:13px">تعتيم
                                                                </div>
                                                                <input type="range"
                                            ...
                                            <div v-if="('design_text_color' in (contents[selected_page]?.find(block => block.id === selected_unique_id)?.fields || {}) )"
                                                class="col-12 px-0 my-2 py-2">
                                                <div class="col-12 px-3 mb-2 font-1">
                                                    لون النص
                                                </div>
                                                <div class="col-12 px-2 mb-3 row">
                                                    ...
                                                    <span
                                                        v-bind:style="{ border: '2px solid ' + (contents[selected_page]?.find(block => block.id === selected_unique_id)?.fields || {}).design_text_color }"
                                                        class="d-flex align-items-center justify-content-between m-1"
                                                        style="width: 25px;height:25px;padding: 2px;border-radius: 50%;cursor: pointer;overflow: hidden;position: relative;">
                                                        <span class="far fa-paint-brush-alt"
                                                            style="font-size:12px;margin:auto;"></span>
                                                        <input type="color" name="design_text_color"
                                                            v-model="(contents[selected_page]?.find(block => block.id === selected_unique_id)?.fields || {}).design_text_color"
                                                            style="width:100%;cursor: pointer;height: 100%;border-radius: inherit;position: absolute;opacity: 0;">
                                                    </span>
                                                </div>
                                            </div>
                                            <div v-if="('design_background_color' in (contents[selected_page]?.find(block => block.id === selected_unique_id)?.fields || {}) )"
                                                class="col-12 px-0 my-2 py-2">
                                                <div class="col-12 px-3 mb-2 font-1">
                                                    لون الخلفية
                                                </div>
                                                <div class="col-12 px-2 mb-3 row">
                                                    <span v-for="color in colors" v-bind:style="{ background: color }"
                                                        :key="color" class="d-flex m-1"
                                                        style="width: 25px;height:25px;padding: 2px;border-radius: 50%;cursor: pointer;overflow: hidden;">
                                                        <input type="radio" name="design_background_color"
                                                            v-bind:value="color"
                                                            v-model="(contents[selected_page]?.find(block => block.id === selected_unique_id)?.fields || {}).design_background_color"
                                                            style="width:100%;cursor: pointer;height: 100%;border-radius: inherit;opacity: 0;">
                                                    </span>
                                                    <span
                                                        v-bind:style="{ border: '2px solid ' + (contents[selected_page]?.find(block => block.id === selected_unique_id)?.fields || {}).design_background_color }"
                                                        class="d-flex align-items-center justify-content-between m-1"
                                                        style="width: 25px;height:25px;padding: 2px;border-radius: 50%;cursor: pointer;overflow: hidden;position: relative;">
                                                        <span class="far fa-paint-brush-alt"
                                                            style="font-size:12px;margin:auto;"></span>
                                                        <input type="color" name="design_background_color"
                                                            v-model="(contents[selected_page]?.find(block => block.id === selected_unique_id)?.fields || {}).design_background_color"
                                                            style="width:100%;cursor: pointer;height: 100%;border-radius: inherit;position: absolute;opacity: 0;">
                                                    </span>
                                                </div>
                                            </div>
                                            <div v-if="('design_text_alignment' in (contents[selected_page]?.find(block => block.id === selected_unique_id)?.fields || {}) )"
                                                class="col-12 px-0 my-2 py-2">
                                                <div class="col-12 px-3 mb-2 font-1">
                                                    محاذاة النصوص
                                                </div>
                                                <div class="col-12 px-2 mb-3 row d-flex justify-content-between ">
                                                    <span v-for="(alignment,alignment_index) in text_alignments"
                                                        :key="alignment_index"
                                                        class="d-flex align-items-center justify-content-center m-1"
                                                        style="width: 40px;height:40px;padding: 2px;cursor: pointer;position: relative;"
                                                        ...
                                                        <input type="radio"
                                                            ...
                                                            :value="alignment_index"
                                                            style="width: 100%;height: 100%;position: absolute;">
                                                    </span>
                                                </div>
                                            </div>
                                            <div v-if="('design_content_alignment' in (contents[selected_page]?.find(block => block.id === selected_unique_id)?.fields || {}) )"
                                                class="col-12 px-0 my-2 py-2">
                                                <div class="col-12 px-3 mb-2 font-1">
                                                    ترتيب القطع
                                                </div>
                                                <div class="col-12 px-2 mb-3 row d-flex justify-content-between ">
                                                    <span v-for="(alignment,alignment_index) in content_alignments"
                                                        :key="alignment_index"
                                                        class="d-flex align-items-center justify-content-center m-1"
                                                        style="width: 40px;height:40px;padding: 2px;cursor: pointer;position: relative;"
                                            ...
                                            <div v-if="('design_min_height' in (contents[selected_page]?.find(block => block.id === selected_unique_id)?.fields || {}) )"
                                                class="col-12 px-0 my-2 py-2">
                                                <div class="col-12 px-3 mb-2 font-1">
                                                    ارتفاع القسم
                                                </div>
                                                <div class="col-12 px-2 mb-3 row d-flex justify-content-between ">
                                                    <input type="range"
                                                        v-model="(contents[selected_page]?.find(block => block.id === selected_unique_id)?.fields || {}).design_min_height"
                                                        class="form-range col-12 p-0" min="0" max="100"
                                                        style="background: rgb(205 205 205);border-radius: 20px;height: 7px;cursor: pointer;border: 2px solid rgb(159 159 159);">
                                                </div>
                                            </div>
                                            <div v-if="('design_custom_code' in (contents[selected_page]?.find(block => block.id === selected_unique_id)?.fields || {}) )"
                                                class="col-12 px-0 my-2 py-2">
                                                <div class="col-12 px-3 mb-2 font-1">
                                                    كود html,css,js مخصص
                                                </div>
                                                <div class="col-12 px-2 mb-3">
                                                    <textarea class="form-control code-highlight"
                                                        style="min-height: 200px;direction: ltr;background: #002b36!important;color:#fff!important"
                                                        v-model="(contents[selected_page]?.find(block => block.id === selected_unique_id)?.fields || {}).design_custom_code"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div style="background: #fff;height:calc(100dvh - 73px);overflow: auto;" class="p-2 col-12">
                                <div class=" p-0 " id="response-contaienr">
                                    <draggable :list="contents[selected_page]" item-key="id">
                                        <template #item="{ element }">
                                            <div style="position:relative;transition: 0.3s all ease-in-out;"
                                                class="content-block" :class="'block_' + element.fields.id"
                                                :id="'block_' + element.fields.id" :ref="'block_' + element.fields.id">
                                                <div style="width: 100%;height: 100%;position: absolute;top: 0px;right: 0px;display: none;z-index: 1000;"
                                                    class="show-on-hover"
                                                    v-on:click="change_selected_component(element.id,element.fields.block_type)">
                                                    <div
                                                        style="width:100%;height:100%;position: absolute;top: 0px;right: 0px;background: #000;opacity: 0.08;cursor: pointer;z-index: 900;">
                                                    </div>
                                                    {{-- <span class="fas mx-1fa-plus append-plus-start"
                                                        style="z-index:1000;cursor: pointer;"
                                                        v-on:click="alerter(element.id +  'before');"></span>
                                                    <span class="fas mx-1fa-plus append-plus-end"
                                                        style="z-index:1000;cursor: pointer;"
                                                ...
                                                <div class='position-relative  border-0 hoverable-elements-builder appened-element'
                                                    ...
                                                    <div class='main-content-of-block py-5 py-lg-9 d-flex align-items-center justify-content-center '
                                                            ...
                                                            <div :class="element.fields.design_text_alignment"
                                                                ...
                                                                <div class="col-12 px-0 d-flex btns-group mt-2"
                                                                    ...
                                                                    <div v-for="button in element.fields['buttons']">
                                                                        <a class="btn mx-1 font-1 font-lg-2 py-1 px-4 py-lg-2 px-lg-5"
                                                        ...
                                                        <div v-if="element.fields.block_type=='component_banner'"
                                                            class="container p-3">
                                                            <div :class="element.fields.design_text_alignment"
                                                                class='col-12 mx-auto '>
                                                                <h2 :class="element.fields.design_text_alignment"
                                                        ...
                                                        <div v-if="element.fields.block_type=='component_text'"
                                                            class="container p-3">
                                                            <div :class="element.fields.design_text_alignment"
                                                                class='col-12 mx-auto '>
                                                                <h2 :class="element.fields.design_text_alignment"
                                                        ...
                                                        <div v-if="element.fields.block_type=='component_text_with_image'"
                                                            ...
                                                            <div :class="[element.fields.design_text_alignment,element.fields.design_content_alignment]"
                                                                ...
                                                                <div
                                                                    class="col-12 col-lg-6 d-flex align-items-center row mx-auto">
                                                                    <div class="col-12 px-0 py-3 row ">
                                                                        ...
                                                                        <div class="col-12 px-0 d-flex btns-group mt-2"
                                                                            :class="element.fields.design_text_alignment">
                                                                            <div
                                                                                v-for="button in element.fields['buttons']">
                                                                                <a class="btn mx-1 font-1 font-lg-2 py-1 px-4 py-lg-2 px-lg-5"
                                                                                    :class="button.fields.class"
                                                                                    :target="button.fields.url_open_type"
                                                                                    style="border-radius: 3px;">
                                                        ...
                                                        <div v-if="element.fields.block_type=='component_faqs'"
                                                            ...
                                                            <div :class="element.fields.design_text_alignment" class=''>
                                                                ...
                                                                <div class="col-12 px-0 py-3 py-lg-5 d-flex faqs-group row"
                                                                    :class="element.fields.design_text_alignment">
                                                                    <div class="col-12 px-0 mb-3 accordion">
                                                                        <div v-for="faq,index in element.fields['faqs']"
                                                                            :class="element.fields.design_columns"
                                                                            class="p-1">
                                                                            <div class="accordion-item mb-1"
                                                                                style="border:1px solid #e7e7ec!important;background: transparent;box-shadow: 0 .5rem .937rem #8c98a41a!important;">
                                                                                <h2 class="accordion-header">
                                                                                    <button
                                                        ...
                                                        <div v-if="element.fields.block_type=='component_html'"
                                                            class="container p-3">
                                                            <h2 :class="element.fields.design_text_alignment"
                                                                class='px-0 font-3 font-lg-5 mb-lg-3 mb-1 content_title'
                                                                style="color:inherit;">@{{element.fields.content_title}}
