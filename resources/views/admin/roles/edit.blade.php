                ...
                <div class="col-12 col-lg-5 p-0 main-box">
                    ...
                    <div class="col-12 p-3 row">
                        ...
                        <div class="col-12 col-lg-6 p-2">
                            ...
                            <div class="col-12 pt-3">
                                <input type="text" name="display_name" required maxlength="190" class="form-control"
                        ...
                        <div class="col-12 p-2">
                            ...
                            <div class="col-12 pt-3">
                                <textarea name="description" class="form-control"
                                    style="min-height:150px">{{old('description', $role ?? "")}}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 p-2">
                                    ...
                                    <tr>
                                            ...
                                            <td style="width: 56px;">
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input" type="checkbox"
                                                        ...
                                                        @if(isset($role) && $role->hasPermissionTo($permission->table . '-create'))
                                        ...
                                        @if($sub_permissions->where('name', $permission->table . '-read')->first())
                                            <td style="width: 56px;">
                                                ...
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input" type="checkbox"
                                                        id="{{$permission->table . '-read'}}" value="{{$permission->table . '-read'}}"
                                                        @if(isset($role) && $role->hasPermissionTo($permission->table . '-read'))
                                                        checked @endif name="permissions[]">
                                                </div>
                                            </td>
                                        @else
                                            ...
                                            <td style="width: 56px;">
                                                ...
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input" type="checkbox"
                                                        ...
                                                        @if(isset($role) && $role->hasPermissionTo($permission->table . '-update'))
                                                        checked @endif name="permissions[]">
                                                </div>
                                            </td>
                                        @else
                                            ...
                                            <td style="width: 56px;">
                                                ...
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input" type="checkbox"
                                                        ...
                                                        @if(isset($role) && $role->hasPermissionTo($permission->table . '-delete'))
                                                        checked @endif name="permissions[]">
                                                </div>
                                            </td>
                                        @else
