            ...
            <div class="col-12 p-0">
                ...
                <div class="col-12 p-2">
                    ...
                    <div class="col-12 pt-3">
                        ...
                        <a target="_blank"
                            href="{{ route('admin.plugins.builder-edit', ['plugin' => $plugin, 'input_parameter' => 'html_content']) }}"
                ...
                <div class="col-12 p-2">
                    ...
                    <div class="col-12 pt-3">
                        <input type="text" name="settings[popup_id]" class="form-control"
                            value="{{ $plugin->settings['popup_id'] ?? '' }}">
                    </div>
                </div>
                ...
                <div class="col-12 p-2">
                    ...
                    <div class="col-12 pt-3">
                        <input type="text" name="settings[btn_url]" class="form-control"
                            value="{{ $plugin->settings['btn_url'] ?? '' }}">
                    </div>
                </div>
                <div class="col-12 p-2">
                    <div class="col-12">
                    ...
                    <div class="col-12 pt-3">
                        <input type="text" name="settings[btn_text]" class="form-control"
                            value="{{ $plugin->settings['btn_text'] ?? '' }}">
                    </div>
                </div>
                <div class="col-12 p-2">
                    <div class="col-12">
                    ...
                    <div class="col-12 pt-3">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" name="settings[btn_url_in_new_tab]"
                                value="1" role="switch"
                                {{ $plugin->settings['btn_url_in_new_tab'] ?? 0 == 1 ? 'checked' : '' }}
                                style="outline: none;">
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 p-2">
                    ...
                    <div class="col-12 pt-3">
                        <input type="text" name="settings[delay_to_show]" class="form-control"
                            value="{{ $plugin->settings['delay_to_show'] ?? '' }}">
                    </div>
                </div>
                ...
                <div class="col-12 p-2">
                    ...
                    <div class="col-12 pt-3">
                        <input type="text" name="settings[reopen_after_hours]" class="form-control"
                            value="{{ $plugin->settings['reopen_after_hours'] ?? '' }}">
                    </div>
                </div>
