            ...
            <div class="col-12 p-0">
                ...
                <div class="col-12 row p-0">
                    ...
                    <div class="col-12 col-lg-4 p-2">
                        ...
                        <div class="col-12 pt-3">
                            <textarea name="emails" class="form-control" style="min-height:300px;direction:ltr"
                                placeholder="ضع كل بريد في سطر منفصل"></textarea>
                        </div>
                    </div>
                    <div class="col-12 col-lg-4 p-2">
                        <div class="col-12">
                        ...
                        <div class="col-12 pt-3">
                            <textarea name="v1" class="form-control" style="min-height:300px" placeholder="ضع كل رسالة في سطر منفصل"></textarea>
                        </div>
                    </div>
                    <div class="col-12 col-lg-4 p-2">
                        <div class="col-12">
