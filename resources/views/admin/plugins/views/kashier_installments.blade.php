    ...
    <form method="POST" action="{{ route('admin.plugins.update', ['plugin' => $plugin]) }}">
        ...
        <div class="col-12 p-0">
            ...
            <div class="col-12 p-2">
                ...
                <div class="col-12 pt-3">
                    <input type="text" name="settings[KASHIER_ACCOUNT_KEY]" class="form-control"
                        value="{{ $plugin->settings['KASHIER_ACCOUNT_KEY'] ?? '' }}">
                </div>
            </div>
            ...
            <div class="col-12 p-2">
                ...
                <div class="col-12 pt-3">
                    <input type="text" name="settings[KASHIER_IFRAME_KEY]" class="form-control"
                        value="{{ $plugin->settings['KASHIER_IFRAME_KEY'] ?? '' }}">
                </div>
            </div>
            <div class="col-12 p-2">
                <div class="col-12">
                ...
                <div class="col-12 pt-3">
                    <input type="text" name="settings[KASHIER_TOKEN]" class="form-control"
                        value="{{ $plugin->settings['KASHIER_TOKEN'] ?? '' }}">
                </div>
            </div>
            <div class="col-12 p-2">
                <div class="col-12">
                ...
                <div class="col-12 pt-3">
                    <select class="form-control" name="settings[KASHIER_MODE]">
                        <option value="live" {{ ($plugin->settings['KASHIER_MODE'] ?? '') == 'live' ? 'selected' : '' }}>مباشر
                        </option>
                        <option value="test" {{ ($plugin->settings['KASHIER_MODE'] ?? '') == 'test' ? 'selected' : '' }}>
                            تجريبي</option>
                    </select>
                </div>
            </div>
            <div class="col-12 p-2">
                ...
                <div class="col-12 pt-3">
                    <select class="form-control" name="settings[KASHIER_CURRENCY]">
                        <option value="EGP" {{ ($plugin->settings['KASHIER_CURRENCY'] ?? '') == 'EGP' ? 'selected' : '' }}>
                            جنيه مصري</option>
                    </select>
                </div>
            </div>
