            ...
            <div class="col-12 p-2">
                ...
                <div class="col-12 pt-3">
                    <input type="text" name="settings[RECAPTCHA_SITE_KEY]" class="form-control"
                        value="{{ $plugin->settings['RECAPTCHA_SITE_KEY'] ?? '' }}">
                </div>
            </div>
            <div class="col-12 p-2">
                <div class="col-12">
                ...
                <div class="col-12 pt-3">
                    <input type="text" name="settings[RECAPTCHA_SECRET_KEY]" class="form-control"
                        value="{{ $plugin->settings['RECAPTCHA_SECRET_KEY'] ?? '' }}">
                </div>
            </div>
            <div class="col-12 p-0">
                <div class="alert alert-info my-2">
                    1- انشاء Recaptcha عبر <br><a
                        href="https://www.google.com/recaptcha/admin/">https://www.google.com/recaptcha/admin/</a>
                    <br>
