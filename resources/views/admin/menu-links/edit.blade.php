                        ...
                        <div class="col-12 col-lg-6 p-2">
                            ...
                            <div class="col-12 pt-3">
                                <select class="form-control select2-select" name="type" id="type">
                                    <option value="CUSTOM_LINK" @if ($menuLink->type == 'CUSTOM_LINK') selected @endif>رابط مخصص
                                    </option>
        ...
        function updateTypeIdList() {
            ...
            $.ajax({
                ...
                for (var i = 0; i < response.length; i++) {
                    ...
                    $('#type_id').append($("<option value='" + response[i].id + "' data-title='" + response[i]
                        .title + "' data-url='" + response[i].url + "' " + selected + ">" + response[i]
                        .title + "</option>"));
