                        ...
                        <div class="col-12 col-lg-6 p-2">
                            ...
                            <div class="col-12 pt-3">
                                <select class="form-control select2-select" name="type" id="type">
                                    <option value="CUSTOM_LINK" @if (old('type') == 'CUSTOM_LINK') selected @endif>رابط مخصص
                                    </option>
        ...
        $('#type').change(function() {
            ...
            $.ajax({
                ...
                for (var i = 0; i < response.length; i++) {
                    $('#type_id').append($("<option></option>").attr("value", response[i].id).attr(
                        "data-title", response[i].title).attr("data-url", response[i].url).text(
                        response[i].title));
                }
            });
        });
