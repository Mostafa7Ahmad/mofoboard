                                    ...
                                    <div class="form-group row ">
                                        <div class="col-12 p-0">
                                            <input class="form-check-input ms-2 me-0" type="checkbox" name="remember"
                                                id="remember" {{ old('remember') || old('remember') == null ? 'checked' : '' }}
                            ...
                            <div class="col-12 px-4 py-2">
                                ...
                                <ul style="list-style:none;" class="p-0 m-0">
                                    @if (Route::has('register'))
                                        <li class=" d-block"><a href="{{ route('register') }}" class="naskh py-2 d-block"
                                                style="text-decoration: none!important;"><span
                                                    class="fas mx-1fa-circle font-small"></span> لا أملك حساب بعد</a></li>
                                    @endif
                                    @if (Route::has('password.request'))
                                        <li class="d-block"><a href="{{ route('password.request') }}"
                                                class="naskh py-2 d-block" style="text-decoration: none!important;"><span
                                                    class="fas mx-1fa-circle font-small"></span> نسيت كلمة المرور</a></li>
                                    @endif
                                </ul>
                            </div>
