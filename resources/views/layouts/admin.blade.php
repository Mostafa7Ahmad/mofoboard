...
<body style="background: #f5f5f5" class="dash">
    ...
    <div class="col-12 d-flex">
        <div style="width: 260px;background: #ffffff;min-height: 100vh;position: fixed;z-index: 900;box-shadow: 0 0 1rem rgba(0,0,0,.1)!important;"
            class="aside active">
                ...
                <div class="col-12 p-1" style="color: var(--background-1)">
                    <div class="col-12 p-0 row">
                        <div class="col-3 py-1 px-1">
                            {{-- <span
                                class="fas mx-1fa-chart-bar font-4 d-flex justify-content-center align-items-center"
                                style="background: #38b59c;height: 40px;width: 40px;border-radius: 50%;color: var(--background-1);"></span>
                            --}}
                        </div>
                        <div class="col-9 ">
                            {{-- <span class="d-inline-block px-2 font-3 pt-1">لوحة التحكم</span> --}}
                            <span
                                style="width: 55px;height: 55px;position: absolute;left: 0px;top: 0px;align-items: center;justify-content: center;cursor: pointer;border-color: transparent!important;"
            ...
            <div class="col-12 px-0">
                <div class="col-12 px-0 aside-menu" style="height: calc(100vh - 190px);overflow: auto;">
        ...
        <div class="main-content in-active" style="overflow: hidden;">
            <div class="col-12 px-0 d-flex justify-content-between top-nav"
                ...
                <div class="col-auto px-0 d-flex justify-content-end cursor-pointer" style="height: 60px;">
