                    ...
                    <div style="width: 700px;" class="mx-auto py-2 d-flex align-items-center justify-content-center">
                        <div class="text-center col-12 p-0 mx-auto">
                            <div class="col-12 px-0 row d-flex justify-content-between ">
                                <div class="col-12 py-9 rounded-2 text-center"
                                    style="text-align: center;background: var(--background-1);margin-top: -5px;">
                                    ...
                                    <div class="col-12 p-2 text-center" style="overflow:auto;">
                                        {{ auth()->user()->name }} @if (auth()->user()->is_online() && 0)
                                            <div class="spinner-grow text-success " role="status"
                                                style="width:15px;height: 15px;margin: 0px 5px"></div>
                                        @endif
                                        <br>
                    ...
                    <div class="col-12 row user-menu ">
                        <nav class="navbar navbar-expand-lg navbar-light bg-light">
                            <div class="container-fluid p-0">
                                <div
                                    class="col-12 px-0 row d-flex m-0 py-3 py-lg-0 justify-content-between align-items-center d-flex d-lg-none">
                                    <div class="navbar-brand navbar-toggler  font-2 px-3 col-auto" data-bs-toggle="collapse"
                                        data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent"
                                        aria-expanded="false" aria-label="Toggle navigation" style="color: inherit;">لوحة
                                        التحكم</div>
                                    <button class="navbar-toggler d-flex col-auto" style="box-shadow:none;" type="button"
                                ...
                                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                    <div class="navbar-nav ms-auto mb-0 mb-lg-0">
                                        <a href="{{ route('user.dashboard') }}"
                                            class="user-menu d-flex align-items-center col-auto justify-content-lg-center justify-content-start py-3 px-2"
                                            style="min-width:120px;border-bottom:6px solid transparent;height: 100%;color: inherit;transition: 0s all ease;">
