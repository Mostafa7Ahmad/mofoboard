@php
    $website_settings = [
        ...
        'website_icon' =>
            $settings[
                'get_website_icon'
            ] /*"data:image/png;base64,". base64_encode(file_get_contents($settings->website_icon()))*/, //lite
    ...
    if (request()->url() == env('APP_URL')) {
        $page_title =
            isset($page_title) && $page_title != null
                ? $website_settings['website_name'] . ' | ' . $page_title
                : $website_settings['website_name'];
    } else {
        $page_title =
            isset($page_title) && $page_title != null
                ? $page_title . ' | ' . $website_settings['website_name']
                : $website_settings['website_name'];
    }
    $page_description =
        isset($page_description) && $page_description != null ? $page_description : $website_settings['website_name'];
    ...
    $website_settings['canonical'] =
        isset($canonical) && $canonical != null ? $canonical : $website_settings['canonical'];
@endphp
