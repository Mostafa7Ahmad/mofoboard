                ...
                <div class="container py-12 py-md-10 text-center">
                    <div class="row">
                        <div class="col-md-7 col-lg-6 col-xl-5 mx-auto">
                            ...
                            <p class="lead px-lg-5 px-xxl-8 mb-1 text-center">نتشرف بتواصلكم معنا وسيتم الرد على استفساراتكم
                                في أقرب وقت ممكن.</p>
                        </div>
                        <!-- /column -->
                    </div>
                                        ...
                                        <div class="col-12">
                                            <div class="form-floating mb-4">
                                                <textarea id="form_message" name="message" class="form-control"
                                                    placeholder="محتوى رسالتك" style="height: 150px" required></textarea>
        ...
        <script>
            grecaptcha.ready(function () {
                document.getElementById('contact-form').addEventListener("submit", function (event) {
                    ...
                    grecaptcha.execute('{{ config('services.google.recaptcha_key') }}', {
                        action: 'contact'
                    }).then(function (token) {
                        console.log(token);
